...
#data=pd.read_csv('/Users/xinxing/Documents/XIN/Work/DrLin/ADNI/NewData/combined_norm_features_cog_edu.csv').fillna(0)
#data=data[data.RID>4000]
...
#1. All feature
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','Entorhinal','Hippocampus','ABFRONTAL', 'ABCINGULATE', 'ABPARIETAL','ABTEMPORAL','ABPOSTERIORCINGULATE','ABPRECUNEUS', 'ABHIPPOCAMPUS','Ventricles','WholeBrain','CSF','ICV','WHITMATHYP','WHITE','GRAY']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','Entorhinal','Hippocampus','ABCingulate_N','ABFrontal_N','ABParietal_N','ABTemporal_N','ABHippocampus_N','ABPrecuneus_N','Ventricles','WholeBrain','WHITMATHYP','WHITE','GRAY']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','Entorhinal','Hippocampus','ABCingulate_N','ABFrontal_N','ABParietal_N','ABTemporal_N','ABHippocampus_N','ABPrecuneus_N','Ventricles','WholeBrain','WHITMATHYP','WHITE','GRAY']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','Entorhinal','Hippocampus','ABCingulate_N','ABFrontal_N','ABParietal_N','ABTemporal_N','ABHippocampus_N','ABPrecuneus_N','Ventricles','WholeBrain','WMH','WHITE','GRAY','PTAU']]
#df=data[['DX','PTAU']]
#df=data[['DX','Entorhinal','Hippocampus','Ventricles','WholeBrain','WHITMATHYP','WHITE','GRAY']]
#df=data[['DX','Entorhinal','Hippocampus','GRAY']]
#df=data[['DX','Entorhinal','Hippocampus','Ventricles']]
#df=data[['DX','Entorhinal','Hippocampus','FDGAngular']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','ABCingulate_N','ABFrontal_N','ABParietal_N','ABTemporal_N','ABHippocampus_N','ABPrecuneus_N']]
#df=data[['DX','FDGAngular']]

#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','AB_Cingulate','AB_Frontal','AB_Parietal','AB_Temporal','AB_Hippocampus','AB_Precuneus','PTAU','Entorhinal','Hippocampus','Ventricles','WholeBrain','WMH','WHITE','GRAY']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost']]
#df=data[['DX','AB_Cingulate','AB_Frontal','AB_Parietal','AB_Temporal','AB_Hippocampus','AB_Precuneus']]
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','AB_Cingulate','AB_Frontal','AB_Parietal','AB_Temporal','AB_Hippocampus','AB_Precuneus']]
...
#2. top8
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost','AB_Frontal','AB_Precuneus','PTAU','Entorhinal','Hippocampus']]
...
#df=data[['DX','ABFrontal_N','ABPrecuneus_N']]
#df=data[['DX','PTAU']]
...
#6. FDG only
#df=data[['DX','FDGAngular','FDGTemporal','FDGCingulumPost']]
#df=data[['DX','FDGAngular','FDGCingulumPost','Hippocampus']]
#7. Hippo+Entro 
