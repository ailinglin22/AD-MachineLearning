...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 08:26:32 2019
...
#FDGAngular
g1_1=df_LMCI[['FDG-Angular','ADNI_MEM']]
g2_1=df_AD[['FDG-Angular','ADNI_MEM']]
...
#ABPrecuneus_N'
g1_2=df_LMCI[['Aß-Precuneus','ADNI_MEM']]
g2_2=df_AD[['Aß-Precuneus','ADNI_MEM']]
...
#FDGTemporal
g1_3=df_LMCI[['FDG-Temporal','ADNI_MEM']]
g2_3=df_AD[['FDG-Temporal','ADNI_MEM']]
...
#ax3.set_xlabel('FDG-Temporal')
#ax3.set_xlim((0,2))
#ax3.set_xticks(np.arange(0,2, 0.5))
at = AnchoredText("r=0.5311",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='lower right',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
#FDGCingulumPost
g1_4=df_LMCI[['FDG-CingulumPost','ADNI_MEM']]
g2_4=df_AD[['FDG-CingulumPost','ADNI_MEM']]
...
#Hippocampus
g1_5=df_LMCI[['Hippocampus','ADNI_MEM']]
g2_5=df_AD[['Hippocampus','ADNI_MEM']]
...
#Entorhinal
g1_6=df_LMCI[['Entorhinal','ADNI_MEM']]
g2_6=df_AD[['Entorhinal','ADNI_MEM']]
...
#Aß-Temporal
g1_7=df_LMCI[['Aß-Temporal','ADNI_MEM']]
g2_7=df_AD[['Aß-Temporal','ADNI_MEM']]
...
#PTau
g1_8=df_LMCI[['pTau','ADNI_MEM']]
g2_8=df_AD[['pTau','ADNI_MEM']]
...
#fig.text(0.1, 0.9, 'b.', ha='center', va='center', fontsize=8, fontweight='bold')



plt.show()
fig.savefig("/Users/xinxing/Desktop/LMCIvsAD_MEM.pdf")