...
g2_1=df_LMCI[['FDG-Angular','ADNI_EF']]
...
g2_2=df_LMCI[['Aß-Precuneus','ADNI_EF']]
...
#ABFrontal_N
g1_3=df_CN[['Aß-Frontal','ADNI_EF']]
g2_3=df_LMCI[['Aß-Frontal','ADNI_EF']]
...
#ABTemporal_N
g1_4=df_CN[['Aß-Temporal','ADNI_EF']]
g2_4=df_LMCI[['Aß-Temporal','ADNI_EF']]
...
ax4.set_xlim((0,0.00005))
ax4.set_xticks(np.arange(0,0.00005, 0.000025))
at = AnchoredText("r=-0.4187",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper right',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
g2_5=df_LMCI[['Hippocampus','ADNI_EF']]
...
g2_6=df_LMCI[['Entorhinal','ADNI_EF']]
...
#ABCingulate_N
g1_7=df_CN[['Aß-Cingulate','ADNI_EF']]
g2_7=df_LMCI[['Aß-Cingulate','ADNI_EF']]
...
ax7.set_xlim((0, 0.0002))
ax7.set_xticks(np.arange(0, 0.0002, 0.0001))
at = AnchoredText("r=-0.2956",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper right',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
plt.show()
fig.savefig("/Users/xinxing/Desktop/CUvsLMCI_EF.pdf")
