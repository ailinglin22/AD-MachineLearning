...
#ax1.set_xlabel('FDG-Angular')
#ax1.set_xlim((0,2))
#ax1.set_xticks(np.arange(0,2, 0.5))

at = AnchoredText("r=0.6695",
...
#ax2.set_xlabel('A'r'$ \beta $''-Precuneus')
ax2.set_xlim((0,0.0004))
ax2.set_xticks(np.arange(0,0.0004, 0.0002))

at = AnchoredText("r=-0.6205",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper right',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
#FDGTemporal
g1_3=df_CN[['FDG-Temporal','ADNI_MEM']]
...
#FDGCingulumPost
g1_4=df_CN[['FDG-CingulumPost','ADNI_MEM']]
...
#ax4.set_xlabel('FDG-CingulumPost')
#ax3.set_xlim((0,2))
#ax3.set_xticks(np.arange(0,2, 0.5))
at = AnchoredText("r=0.6335",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper left',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
#ABFrontal_N
g1_7=df_CN[['Aß-Temporal','ADNI_MEM']]
...
#fig.text(0.1, 0.9, 'c.', ha='center', va='center', fontsize=8, fontweight='bold')


plt.show()

fig.savefig("/Users/xinxing/Desktop/CNvsAD_MEM.pdf")