...
df=data[['DX','FDG-Angular','FDG-Temporal','FDG-CingulumPost','Aß-Precuneus','pTau','Entorhinal','Hippocampus','Aß-Temporal','ADNI_MEM','ADNI_EF']]
...
#FDGAngular
g1_1=df_LMCI[['FDG-Angular','ADNI_EF']]
g2_1=df_AD[['FDG-Angular','ADNI_EF']]
...
#ABPrecuneus_N'
g1_2=df_LMCI[['Aß-Precuneus','ADNI_EF']]
g2_2=df_AD[['Aß-Precuneus','ADNI_EF']]
...
#FDGTemporal
g1_3=df_LMCI[['FDG-Temporal','ADNI_EF']]
g2_3=df_AD[['FDG-Temporal','ADNI_EF']]
...
#ax3.set_xlabel('FDGTemporal')
#ax3.set_xlim((0,2))
#ax3.set_xticks(np.arange(0,2, 0.5))
at = AnchoredText("r=0.5315",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper left',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
ax3.set_title('FDG-Temporal', fontweight='bold', fontsize=25)


#FDGCingulumPost
g1_4=df_LMCI[['FDG-CingulumPost','ADNI_EF']]
g2_4=df_AD[['FDG-CingulumPost','ADNI_EF']]
...
#ax4.set_xlabel('FDGCingulumPost')
#ax3.set_xlim((0,2))
#ax3.set_xticks(np.arange(0,2, 0.5))
at = AnchoredText("r=0.4882",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper left',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
ax4.set_title('FDG-CingulumPost', fontweight='bold', fontsize=25)

#Hippocampus
g1_5=df_LMCI[['Hippocampus','ADNI_EF']]
g2_5=df_AD[['Hippocampus','ADNI_EF']]
...
#Entorhinal
g1_6=df_LMCI[['Entorhinal','ADNI_EF']]
g2_6=df_AD[['Entorhinal','ADNI_EF']]
...
#Aß-Temporal
g1_7=df_LMCI[['Aß-Temporal','ADNI_EF']]
g2_7=df_AD[['Aß-Temporal','ADNI_EF']]
...
#ax7.set_xlabel('Ventricles')
#ax7.set_xlim((0, 0.00002))
#ax7.set_xticks(np.arange(0, 0.00002, 0.00001))
at = AnchoredText("r=-0.4431",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='upper right',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
ax7.set_title('Aß-Temporal', fontweight='bold', fontsize=25)

#PTau
g1_8=df_LMCI[['pTau','ADNI_EF']]
g2_8=df_AD[['pTau','ADNI_EF']]
...
fig.text(0.08, 0.5, 'Composite Executive \n Functioning Score', ha='center', va='center', rotation='vertical',fontsize=35,fontweight='bold')


plt.show()
fig.savefig("/Users/xinxing/Desktop/LMCIvsAD_EF.pdf")