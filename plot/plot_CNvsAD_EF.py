...
df=data[['DX','FDG-Angular','FDG-Temporal','FDG-CingulumPost','Aß-Temporal','Aß-Precuneus','pTau','Entorhinal','Hippocampus','ADNI_MEM','ADNI_EF']]
...
#FDGAngular
g1_1=df_CN[['FDG-Angular','ADNI_EF']]
...
#ABPrecuneus_N'
g1_2=df_CN[['Aß-Precuneus','ADNI_EF']]
...
#FDGTemporal
g1_3=df_CN[['FDG-Temporal','ADNI_EF']]
...
#FDGCingulumPost
g1_4=df_CN[['FDG-CingulumPost','ADNI_EF']]
...
#Hippocampus
g1_5=df_CN[['Hippocampus','ADNI_EF']]
...
#ABTemporal_N
g1_7=df_CN[['Aß-Temporal','ADNI_EF']]
...
#ax7.set_xlabel('ABFrontal_N')
ax7.set_xlim((0, 0.00006))
ax7.set_xticks(np.arange(0, 0.00006, 0.00002))
at = AnchoredText("r=-0.5758",
                  prop=dict(size=18,fontweight="bold"), frameon=False,
                  loc='lower left',
                  )
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
...
ax7.set_title('A'r'$ \beta $''-Temporal', fontweight='bold', fontsize=25)

plt.legend(loc='upper left', bbox_to_anchor=(1, 1), prop={'size': 20})


#PTau
g1_8=df_CN[['pTau','ADNI_EF']]
...
plt.show()
fig.savefig("/Users/xinxing/Desktop/CUvsAD_EF.pdf")